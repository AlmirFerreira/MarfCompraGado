...
(function (global, factory) {
    ...
    var Sizzle =
        ...
        (function (window) {
            ...
            setDocument = Sizzle.setDocument = function (node) {
                ...
                // See http://bugs.$.com/ticket/13378
                rbuggyQSA = [];
                    ...
                    for (i = 0; i < hasScripts; i++) {
                        ...
                        if (rscriptType.test(node.type || "") &&
                            ...
                            if (node.src) {
                                ...
                                $.globalEval(node.textContent.replace(rcleanScript, ""));
                            }
                        }
                    }
                }
    ...
    function remove(elem, selector, keepData) {
        ...
        for (; (node = nodes[i]) != null; i++) {
            ...
            if (node.parentNode) {
                if (keepData && $.contains(node.ownerDocument, node)) {
    ...
    function defaultDisplay(nodeName) {
        ...
        if (!display) {
            ...
            if (display === "none" || !display) {
                ...
                iframe = (iframe || $("<iframe frameborder='0' width='0' height='0'/>"))
            ...
            if (show) {
                ...
                if (display !== "none" || !hidden) {
                    dataPriv.set(
                        elem,
                        "olddisplay",
                        hidden ? display : $.css(elem, "display")
                    );
                }
            }
        }
    ...
    // http://web.archive.org/web/20100324014747/http://blindsignals.com/index.php/2009/07/$-delay/
        ...
        simulate: function (type, elem, event) {
            var e = $.extend(
                ...
                event,
                {
                    ...
                    // $.event.stopPropagation function we had a check for existence of
                    ...
                    // events is still used, but was moved to $.event.stopPropagation function
